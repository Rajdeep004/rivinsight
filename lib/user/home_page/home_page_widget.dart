          ...
          children: [
            Padding(
              ...
              child: RefreshIndicator(
                ...
                onRefresh: () async {
                  setState(() {
                    FFAppState().clearFloodRiskCache();
                                ...
                                child: Stack(
                                  children: [
                                    ...
                                    InkWell(
                                      ...
                                      onTap: () async {
                                        context.pushNamed('HistoryDetails');
                                      },
                                      child: Container(
                                        width: double.infinity,
                      ...
                      child: Builder(
                        builder: (context) => Padding(
                          ...
                          child: FutureBuilder<List<RiversRow>>(
                            future: FFAppState()
                                .floodRisk(
                              requestFn: () => RiversTable().querySingleRow(
                                queryFn: (q) => q.eq(
                                  'id',
                                  1,
                                ),
                            ...
                            builder: (context, snapshot) {
                              ...
                              List<RiversRow> containerRiversRowList =
                                  snapshot.data!;
                              final containerRiversRow =
                              ...
                              return InkWell(
                                ...
                                onTap: () async {
                                  ...
                                  setState(() {
                                    _model.floodRisk = () {
                                      if (containerRiversRow!.floodrisk >
                                          80.0) {
                                        return 'red';
                                      } else if (containerRiversRow!.floodrisk >
                                          40.0) {
                                        return 'yellow';
                                      } else {
                                        return 'green';
                                        ...
                                        return Dialog(
                                          ...
                                          child: GestureDetector(
                                            onTap: () => _model
                                                ...
                                                : FocusScope.of(context)
                                                    .unfocus(),
                                            child: AlertCompoWidget(
                                              title: FFLocalizations.of(context)
                                                  .getText(
                                                'yddrjcsh' /* Urgent Warning!  */,
                                              ),
                                              content:
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                '5agebjt9' /* The river has reached the Red ... */,
                                              ),
                                              floodRisk:
                                                  FlutterFlowTheme.of(context)
                                                      .error,
                                  ...
                                  } else if (_model.floodRisk == 'yellow') {
                                    await showDialog(
                                      barrierColor: Color(0x00F9CF58),
                                      context: context,
                                      builder: (dialogContext) {
                                        return Dialog(
                                          elevation: 0,
                                          ...
                                          child: GestureDetector(
                                            ...
                                            child: AlertCompoWidget(
                                              ...
                                              content:
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                'xlfkpoz8' /* The river has entered the Yell... */,
                                              ),
                                              floodRisk:
                                                  FlutterFlowTheme.of(context)
                                                      .warning,
                                          ...
                                          child: GestureDetector(
                                            ...
                                            child: AlertCompoWidget(
                                              ...
                                              content:
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                '2alv2crl' /* The river is currently in the ... */,
                                              ),
                                              floodRisk:
                                                  FlutterFlowTheme.of(context)
                                                      .success,
